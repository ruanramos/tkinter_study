...
def create_frame():
    ...
    listPlayersAlphabeticalButton = Button(frame, text="List Players By Alphabetical Order", bd=5, bg="skyblue1",
                                           font=button_font)
    ...
    listPlayersRegisterButton = Button(frame, text="List Players By Register Order", bd=5, bg="skyblue1",
                                       font=button_font)
    ...
    add_player_button_var = Button(frame, text="Add A New Player", bd=5, bg="plum1", command=add_player_button,
                                   font=button_font)
...
def save_player(variable1, variable2, variable3, main_frame):
    ...
    opgglink = 'http://br.op.gg/summoner/userName={0}'.format(nickname)
    ...
    player_tuple = (name, nickname, elo, elo_number, first_role, second_role, opgglink)
    print(player_tuple)

    """Insert player into db players table and commit change"""
    sql = "INSERT INTO players(name, nickname, elo, elo_number, first_role," \
          " second_role, op_gg_link) VALUES (%s, %s, %s, %s, %s, %s, %s)"
...
def create_list_names_radiobuttons(order):
    ...
    delete_player_button_var = Button(frame_buttons[0], text="Delete Player", bg="plum1", bd=5, font=button_font,
                                      width=30)
    delete_player_button_var["command"] = partial(delete_player_db, name, order)
    delete_player_button_var.pack(padx=20, pady=5)
    archive_button_var = Button(frame_buttons[0], text="Archive.txt", bg="plum1", bd=5, font=button_font, width=30)
    delete_player_button_var.pack(padx=20, pady=5)
...
elos = {"unranked": -1, "bronze 5": 0, "bronze 4": 1, "bronze 3": 2, "bronze 2": 3, "bronze 1": 4, "silver 5": 5,
        ...
        "gold 3": 12, "gold 2": 13, "gold 1": 14, "platinum 5": 15, "platinum 4": 16, "platinum 3": 17,
        "platinum 2": 18,
